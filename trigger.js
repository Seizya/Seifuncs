document.addEventListener("DOMContentLoaded", () => {
    ...
    Promise.all([new Promise((resolve) => {
        ...
        _T0.parentNode.insertBefore(sfcss, _T0.nextSibling);
    })
})